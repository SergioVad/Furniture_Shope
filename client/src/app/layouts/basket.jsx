...
const Basket = () => {
    ...
    if (arrayBasket.length === 0) {
        return (
            <div className="h2 d-flex justify-content-center pt-4 basket">
                В корзине нет товаров
            </div>
        );
    } else {
        const sumPresentPrice = arrayBasket.map((u) => +u.present_price);
        const fullSum = sumPresentPrice.reduce((acc, item) => {
            return (acc += item);
        });
                ...
                <div className="d-flex basket">
                    <div className="d-flex flex-column offset-2 col-10 p-3">
                        ...
                        <div className="mx-3 d-flex justify-content-end align-items-center">
                            ...
                            <div className="ms-5 fw-bold text-dark h4 mb-0">
                                {`${addRuble(fullSum)}`}
                            </div>
                        </div>
